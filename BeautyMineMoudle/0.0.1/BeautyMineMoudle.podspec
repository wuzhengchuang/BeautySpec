#
# Be sure to run `pod lib lint BeautyMineMoudle.podspec' to ensure this is a
...
TODO: 美颜我的模块
  ...
  s.source_files = 'BeautyMineMoudle/Classes/**/*'
  
  # s.resource_bundles = {
  #   'BeautyMineMoudle' => ['BeautyMineMoudle/Assets/*.png']
  # }
